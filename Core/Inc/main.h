...
#define STEERING_RIGHT_PADDLE_BUTTON_Pin GPIO_PIN_4
#define STEERING_RIGHT_PADDLE_BUTTON_GPIO_Port GPIOC
...
#define DASHBOARD_NETURAL_LED_Port GPIOA
#define DASHBOARD_NEUTRAL_LED_Pin GPIO_PIN_7
