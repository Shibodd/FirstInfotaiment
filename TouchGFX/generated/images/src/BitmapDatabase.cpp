...
extern const unsigned char image_battery_high[]; // BITMAP_BATTERY_HIGH_ID = 4, Size: 83x48 pixels
extern const unsigned char image_battery_low[]; // BITMAP_BATTERY_LOW_ID = 5, Size: 83x48 pixels
extern const unsigned char image_battery_ok[]; // BITMAP_BATTERY_OK_ID = 6, Size: 83x48 pixels
...
extern const unsigned char image_btn_next[]; // BITMAP_BTN_NEXT_ID = 10, Size: 50x50 pixels
extern const unsigned char image_btn_prev[]; // BITMAP_BTN_PREV_ID = 11, Size: 50x50 pixels
...
extern const unsigned char image_orin_t_high[]; // BITMAP_ORIN_T_HIGH_ID = 20, Size: 35x34 pixels
extern const unsigned char image_orin_t_ok[]; // BITMAP_ORIN_T_OK_ID = 21, Size: 35x34 pixels
extern const unsigned char image_progress_bar_large[]; // BITMAP_PROGRESS_BAR_LARGE_ID = 22, Size: 250x20 pixels
extern const unsigned char image_water_high[]; // BITMAP_WATER_HIGH_ID = 23, Size: 43x31 pixels
extern const unsigned char image_water_low[]; // BITMAP_WATER_LOW_ID = 24, Size: 43x31 pixels
extern const unsigned char image_water_ok[]; // BITMAP_WATER_OK_ID = 25, Size: 43x31 pixels
